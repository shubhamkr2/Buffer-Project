      ...
      <HStack spacing="120px" pt="80px">
        <Stack>
          ...
          <HStack spacing="20px" pb="20px">
            <Image
              w="25px"
              src="https://www.nicepng.com/png/detail/23-230042_instagram-logo-black-borders-png-transparent-background-instagram.png"
              alt="insta"
            />
            <Image
              w="25px"
              src="https://img.favpng.com/15/6/4/facebook-logo-icon-png-favpng-NSdF9e3aktdSq4DCeYrXsd0sk_t.jpg"
              alt="face"
            />
            <Image
              w="25px"
            ...
            <Image
              w="25px"
              src="https://pngimg.com/uploads/tiktok/tiktok_PNG27.png"
              alt="tik"
            />
            <Image
              w="25px"
              src="https://cdn-icons-png.flaticon.com/512/49/49656.png"
              alt="linked"
            />
            <Image
              w="25px"
              src="https://i.pinimg.com/originals/40/e2/6b/40e26beab6a4049d7d52cee459a7dbb8.png"
              alt="pin"
            />
          </HStack>
          <Text fontWeight="bold">Download</Text>
          <HStack>
            <a href="https://apps.apple.com/app/apple-store/id490474324?pt=936146&ct=SiteFooter&mt=8">
              <Button
                h="30px"
            ...
            <a href="https://play.google.com/store/apps/details?id=org.buffer.android&hl=en">
              <Button
                h="30px"
                border="1px solid blue"
                borderRadius="15px"
        ...
        <Stack>
          <Text fontWeight="bold" mt="-10" fontSize="22px">
            Resources
          </Text>
        ...
        <Stack>
          <Text fontWeight="bold" mt="8" fontSize="22px">
            Company
          </Text>
